...
SimpleSelect.onTap = SimpleSelect.onClick = function(state, e) {
  ...
  if (CommonSelectors.noTarget(e) || e.featureTarget.layer.type !== 'line') return this.clickAnywhere(state, e); // also tap
  if (CommonSelectors.isOfMetaType(Constants.meta.VERTEX)(e)) return this.clickOnVertex(state, e); //tap
  if (CommonSelectors.isFeature(e) && e.featureTarget.layer.type === 'line') return this.clickOnFeature(state, e);
};
